...
// --- PLANTILLA HTML (V9 - Ajustes de tamaño y thumbnails inclinados) ---
const generateHTML = (data) => {
  ...
  <head>
    ...
    <style>
      ...
      /* Efecto de inclinación para thumbnails */
      .skew-container {
        transform: skewX(-12deg);
      }
      .unskew-content {
        transform: skewX(12deg) scale(1.2); /* Escala para compensar el corte */
      }
    </style>
  </head>
  <body class="bg-gray-900 m-0 p-0 flex justify-center">
    <div class="relative bg-black overflow-hidden flex flex-col justify-between" style="width: 1080px; height: 1920px;">
      ...
      <div class="relative z-20 w-full pb-20 flex flex-col items-center">
        ...
        <!-- Precios (Reducidos 15% y menos peso) -->
        ...
        <!-- Miniaturas Inclinadas (De orilla a orilla) -->
        ...
        <!-- Botón WhatsApp (Reducido 15% y menos peso) -->
